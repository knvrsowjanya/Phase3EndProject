package restAPIPhaseEndProject;
...
public class ReusableMethods {
		...
		public static Response createNewEmployee(String name, String lastName, String salary, String email) {
		...
		public static Response updateEmployee(String id) {
			HashMap<String, Object> requestBody = new HashMap<String, Object>();
			requestBody.put("firstName", "Tom");
			requestBody.put("lastName", "Dae");
			requestBody.put("salary", "100000");
			requestBody.put("email", "an@gmail.com");
